...
public class Crystal_Skill : Skill
{
    ...
    protected override void Start()
    {
        ...
        unlockCloneInsteadButton.GetComponent<Button>().onClick.AddListener(UnlockCrystalMirrage);
    ...
    private void UnlockCrystalMirrage()
    {
