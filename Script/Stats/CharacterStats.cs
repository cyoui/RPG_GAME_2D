...
public class CharacterStats : MonoBehaviour
{
    ...
    public void MakeVulnerableFor(float _duration) => StartCoroutine(VulnerableForCorrutine(_duration));


    private IEnumerator VulnerableForCorrutine(float _duration)
    {
        isVulnerable = true;
